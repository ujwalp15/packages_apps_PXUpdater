...
package com.projectx.updater.service;
...
import com.projectx.updater.requests.UpdatesJsonObjectRequest;
import com.projectx.updater.UpdatesSettings;
...
public class UpdateCheckService extends IntentService
    ...
    // request actions
    public static final String ACTION_CHECK = "com.cyanogenmod.pxupdater.action.CHECK";
    public static final String ACTION_CANCEL_CHECK = "com.cyanogenmod.pxupdater.action.CANCEL_CHECK";

    // broadcast actions
    public static final String ACTION_CHECK_FINISHED = "com.cyanogenmod.pxupdater.action.UPDATE_CHECK_FINISHED";
    ...
    private URI getServerURI() {
        String propertyUpdateUri = SystemProperties.get("px.updater.uri");
